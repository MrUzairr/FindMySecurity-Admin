...
const UserManagement: React.FC = () => {
  ...
  const handleConfirmBlock = async () => {
    ...
    const user = users.find((u) => u.id === userIdToBlock);
    ...
    try {
      ...
      setUsers(
        users.map((u) => (u.id === userIdToBlock ? { ...u, blocked: !isBlocked } : u))
      );
                    ...
                    <tr key={user.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                      ...
                      <td className="px-3 py-2 sm:px-4 sm:py-3 whitespace-nowrap text-xs sm:text-sm text-gray-700 dark:text-gray-300 flex gap-2">
                        ...
                        <button
                          ...
                          className={`relative group flex items-center gap-1 px-3 py-1 rounded-lg ${
                            user.blocked
                  ...
                  {users.map((user) => (
                    <tr key={user.id} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                      ...
                      <td className="px-2 py-2 whitespace-nowrap text-xs text-gray-700 dark:text-gray-300 flex gap-2">
                        ...
                        <button
                          onClick={() => handleBlockUser(user.id)}
                          className={`relative group flex items-center gap-1 px-2 py-1 rounded-lg ${
                            user.blocked
                              ? "bg-green-500 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700"
                              : "bg-orange-500 hover:bg-orange-600 dark:bg-orange-600 dark:hover:bg-orange-700"
                          } text-white transition-transform transform hover:scale-105 duration-200`}
  ...
  >
    ...
    <span className="absolute hidden group-hover:block bg-gray-800 text-white text-xs rounded py-1 px-2 -top-8 left-1/2 transform -translate-x-1/2">
      View Logs
        ...
        {isBlockModalOpen && userIdToBlock && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[2000] p-4">
            <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg max-w-md w-full p-6">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-200">
                  Confirm {users.find((u) => u.id === userIdToBlock)?.blocked ? "Unblock" : "Block"}
                </h3>
                <button
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 mb-6">
                Are you sure you want to {users.find((u) => u.id === userIdToBlock)?.blocked ? "unblock" : "block"} user ID {userIdToBlock}?
              </p>
              <div className="flex justify-end gap-2">
                <button
                  onClick={handleCancelBlock}
                ...
                <button
                  ...
                  className={`px-4 py-2 ${
                    users.find((u) => u.id === userIdToBlock)?.blocked
                      ? "bg-green-500 hover:bg-green-600 dark:hover:bg-green-700"
                      : "bg-orange-500 hover:bg-orange-600 dark:hover:bg-orange-700"
              ...
              <div className="space-y-4">
                ...
                {selectedUser.roleId === 3 && selectedUser.individualProfessional && (
                  <>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {selectedUser.individualProfessional.profile && (
                        <>
                          <div>
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                              Screen Name
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.screenName || "N/A"}
                            </p>
                          </div>
                          <div>
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.profileHeadline || "N/A"}
                            </p>
                          </div>
                          <div>
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.hourlyRate
                                ? `$${selectedUser.individualProfessional.profile.hourlyRate}`
                                : "N/A"}
                            </p>
                          </div>
                          <div>
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.hourlyRatetemp
                                ? `$${selectedUser.individualProfessional.profile.hourlyRatetemp}`
                                : "N/A"}
                            </p>
                          </div>
                          <div className="col-span-2">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.feesDescription || "N/A"}
                            </p>
                          </div>
                          <div className="col-span-2">
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.aboutMe || "N/A"}
                            </p>
                          </div>
                          <div className="col-span-2">
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.experience || "N/A"}
                            </p>
                          </div>
                          <div className="col-span-2">
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.qualifications || "N/A"}
                            </p>
                          </div>
                          <div className="col-span-2">
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-blue-400">
                              {selectedUser.individualProfessional.profile.website ? (
                                <a
                                  href={selectedUser.individualProfessional.profile.website}
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  {selectedUser.individualProfessional.profile.website}
                          ...
                          <div>
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.homeTelephone || "N/A"}
                            </p>
                          </div>
                          <div>
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.mobileTelephone || "N/A"}
                            </p>
                          </div>
                          <div className="col-span-2">
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.otherService || "N/A"}
                            </p>
                          </div>
                          <div className="col-span-2">
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.serviceRequirements?.join(", ") || "N/A"}
                            </p>
                          </div>
                          <div className="col-span-2">
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.securityServicesOfferings?.join(", ") || "N/A"}
                            </p>
                          </div>
                          <div>
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.gender || "N/A"}
                            </p>
                          </div>
                          <div>
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.postcode || "N/A"}
                            </p>
                          </div>
                          <div className="col-span-2">
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {selectedUser.individualProfessional.profile.availabilityDescription || "N/A"}
                            </p>
                          </div>
                          <div className="col-span-2">
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            {selectedUser.individualProfessional.profile.weeklySchedule &&
                            Object.values(selectedUser.individualProfessional.profile.weeklySchedule).some(
                              (value) => typeof value === "string" && value.trim() !== ""
                            ) ? (
                              <ul className="mt-1 text-sm text-gray-900 dark:text-gray-100 list-disc pl-5">
                                {Object.entries(selectedUser.individualProfessional.profile.weeklySchedule).map(
                                  ([period, value]) =>
                                    typeof value === "string" &&
                                    value.trim() !== "" && (
                                      <li key={period}>
                              ...
                              <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">N/A</p>
                            )}
                          </div>
                          <div>
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {new Date(selectedUser.individualProfessional.profile.createdAt).toLocaleString()}
                            </p>
                          </div>
                          <div>
                            <span className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <p className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                              {new Date(selectedUser.individualProfessional.profile.updatedAt).toLocaleString()}
                            </p>
                          </div>
                        </>
                      )}
